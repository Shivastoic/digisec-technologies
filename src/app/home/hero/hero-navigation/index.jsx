...
export default function HeroNavigation({ navigationData }) {
    ...
    return (
        ...
        <div className="flex flex-col items-center justify-center gap-3 w-full">
            <div className="flex gap-1 rounded-full border-2 border-white/15 bg-white/10 backdrop-blur-lg w-fit p-1">
                {
                    ...
                    navigationData.map((data, index) => (
                        ...
                        <button
                            ...
                            className={`duration-150 px-3 py-2 rounded-full text-white ${
                                activeIndex === index ? 'bg-black/20' : 'hover:bg-black/20'
                            }`}
                        >
                            {data.label}
                        </button>
                    ...
                    <div className="flex flex-col p-6 gap-12">
                        ...
                        <Link href={ navigationData[activeIndex]?.content.link }>
                            <button className="rounded-full relative px-4 py-2 bg-white group border-2 border-white text-white text-lg">
                                <div className="bg-blue_dark rounded-full absolute top-0 left-0 group-hover:top-1 group-hover:left-1 duration-200 w-full h-full flex gap-2 items-center justify-center">
                                    Learn More
